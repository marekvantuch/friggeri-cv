...
Over the last couple of years I have used wide range of languages and technologies including short time of JAVA Android development.
I mostly work with MVC and have designed and implemented several REST APIs. I try co combine best features of each of
the languages and technologies I've learned in projects I work on.
I enjoy challenges, learning new technologies solving issues.
...
\begin{entrylist}
  ...
  {Public radio broadcaster of Czech Republic}
  {
    \position
      ...
      {Drupal, PHP, JavaScript, REST API}
      {
        With a colleague, we have implemented a news portal based on Drupal. Project had specific requirements for
        it's front-office, speed and ease of use for it's users. As part of the project I have designed and implemented
        an API for it's mobile application.
      }\\
      \emph{Key Successes:}
      \begin{itemize}
  ...
  {UX focused digital agency}
  {
    ...
    {
      Cooperated as a freelancer on various projects. Most of those I was the sole developer and architect.
      Projects were ranging from one site e-commerce solutions to sizeable platforms.
      Largest project was a custom administration for German newspaper house which is still being developed today and will
      be eventually re-sold as a product.
